...
namespace StarterKit
{
	...
	class Game : GameWindow
	{
		...
		bool loaded;
		Bitmap bitmap0 = new Bitmap( @"tile_1_1.bmp" );
		Bitmap bitmap1 = new Bitmap( @"tile_2_1.bmp" );
		Bitmap bitmap2 = new Bitmap( @"tile_2_2.bmp" );
		Bitmap bitmap3 = new Bitmap( @"tile_3_1.bmp" );
