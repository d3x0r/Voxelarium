...
namespace BEPUphysics.Vehicle
{
    ...
    public class CylinderCastWheelShape : WheelShape
    {
        ...
        public override void UpdateWorldTransform()
        {
            ...
            worldTransform.M4.Add( ref newPosition, out worldTransform.M4 );
        }
        ...
        protected internal override void Initialize()
        {
			...
			Vector3 expansion; wheel.suspension.localDirection.Mult( wheel.suspension.restLength, out expansion );
            if (expansion.X > 0)
