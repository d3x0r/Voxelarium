...
namespace BEPUphysics.Vehicle
{
    ...
    public class RaycastWheelShape : WheelShape
    {
        ...
        public override void UpdateWorldTransform()
        {
            ...
            wheel.vehicle.Body.BufferedStates.InterpolatedStates.Position.Add( ref worldAttachmentPoint, out worldAttachmentPoint );
            ...
            worldTransform.Translate(ref newPosition );
        }
            ...
            for (int i = 0; i < detector.CollisionInformation.pairs.Count; i++)
            {
                ...
                if (testCollidable != null)
                {
                    if (CollisionRules.CollisionRuleCalculator(this, testCollidable) == CollisionRule.Normal &&
                        testCollidable.RayCast(new Ray( ref wheel.suspension.worldAttachmentPoint, ref wheel.suspension.worldDirection), wheel.suspension.restLength, out rayHit) &&
        ...
        protected internal override void Initialize()
        {
			...
			Vector3 endpoint; startpoint.AddScaled( ref wheel.suspension.localDirection, wheel.suspension.restLength, out endpoint );
            Vector3 min, max;
