...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms
{
    ...
    public static class MPRToolbox
    {
            ...
            while (true)
            {
                ...
                if (dot >= 0)
                {
                    ...
                    if (v0v1v2v3volume > Toolbox.Epsilon * .01f)
                    {
						...
						v1A.Mult( v1Weight, out position );
						position.AddScaled( ref v2A, v2Weight, out position );
						position.AddScaled( ref v3A, v3Weight, out position );
        ...
        static bool VerifySimplex(ref Vector3 v0, ref Vector3 v1, ref Vector3 v2, ref Vector3 v3, ref Vector3 direction)
        {
			...
			//v1, v0, v3
			Vector3 cross; Vector3.CrossDiff2( ref v0, ref v1, ref v3, ref v1, out cross);
            float planeProduct1 = Vector3.Dot( ref cross, ref direction );
            //v3, v0, v2
            Vector3.CrossDiff2( ref v0, ref v3, ref v2, ref v3, out cross );
            float planeProduct2 = Vector3.Dot( ref cross, ref direction );
            //v2, v0, v1
            Vector3.CrossDiff2( ref v0, ref v2, ref v1, ref v2, out cross );
            float planeProduct3 = Vector3.Dot( ref cross, ref direction );
        ...
        public static bool Sweep(ConvexShape shapeA, ConvexShape shapeB, ref Vector3 sweepA, ref Vector3 sweepB, ref RigidTransform transformA, ref RigidTransform transformB, out RayHit hit)
        {
            ...
            if (negativeLength)
            {
                ...
                hit.Location.AddScaled( ref sweepA, hit.T, out hit.Location );
                return true;
            }
            ...
            if (LocalSweepCast(shapeA, shapeB, sweepLength, rayLengthSquared, ref localDirection, ref sweep, ref localTransformB, out hit))
            {
				...
				Vector3 minkowskiRayHit; localDirection.Mult( -hit.T, out minkowskiRayHit );
        ...
        internal static void GetLocalPosition(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref Vector3 minkowskiPosition, out Vector3 position)
        {
            ...
            if (n.LengthSquared() < Toolbox.Epsilon)
            {
                ...
                float dot = Vector3.DotDiff1( ref v1, ref minkowskiPosition, ref rayDirection );
                ...
                //Origin is inside.
                //Compute barycentric coordinates along simplex (segment).
                float dotv0 = Vector3.DotDiff1( ref v0, ref minkowskiPosition, ref rayDirection );
                //Dot > 0, so dotv0 starts out negative.
