...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms.GJK
{
    ...
    public struct PairSimplex
    {
        ...
        internal void VerifyContributions()
        {
            ...
            {
                case SimplexState.Point:
                    if (Vector3.DistanceDel1(ref SimplexA.A, ref SimplexB.A, ref A ) > .0001f)
                ...
                case SimplexState.Segment:
                    ...
                    if (Vector3.DistanceDel1( ref SimplexA.B, ref SimplexB.B, ref B ) > .0001f)
                        Debug.WriteLine("break.");
                    break;
                case SimplexState.Triangle:
                    if (Vector3.DistanceDel1( ref SimplexA.A, ref SimplexB.A, ref A ) > .0001f)
                    ...
                    if (Vector3.DistanceDel1( ref SimplexA.C, ref SimplexB.C, ref C ) > .0001f)
                        Debug.WriteLine("break.");
                    break;
                ...
                case SimplexState.Tetrahedron:
                    ...
                    if (Vector3.DistanceDel1( ref SimplexA.D, ref SimplexB.D, ref D ) > .0001f)
                        Debug.WriteLine("break.");
                    break;
            }
        }
