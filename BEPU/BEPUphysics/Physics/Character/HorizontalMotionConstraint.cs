    ...
    public class HorizontalMotionConstraint : SolverUpdateable
    {
        ...
        public override void Update(float dt)
        {
            ...
            if (MovementMode != MovementMode.Floating)
            {
                ...
                if (isTryingToMove)
                {
                    ...
                    Plane plane = new Plane(ref supportData.Normal, 0);
                    float t;
                    ...
                    velocityDirection.Invert(out linearJacobianB1);
                    offVelocityDirection.Invert(out linearJacobianB2);
                ...
                else
                {
                    ...
                    linearJacobianA1.Invert(out linearJacobianB1);
                    linearJacobianA2.Invert(out linearJacobianB2);
                ...
                if (supportEntity != null)
                {
                    ...
                    Vector3 supportToContact; supportData.Position.Sub(ref supportEntity.position, out supportToContact);
            ...
            else
            {
                ...
                Vector3.Cross(ref linearJacobianA1, ref characterBody.orientationMatrix.M2, out linearJacobianA2);
            ...
            if (!isTryingToMove && MovementMode == MovementMode.Traction && supportEntity != null)
            {
                ...
                if (timeSinceTransition >= timeUntilPositionAnchor)
                {
                    ...
                    Vector3 tmp;
                    positionLocalOffset.Add(ref characterBody.position, out tmp);
                    tmp.Sub(ref supportEntity.position, out positionLocalOffset);
                ...
                if (timeSinceTransition < 0)
                {
                    ...
                    targetPosition.Add(ref characterBody.position, out targetPosition);
                    Vector3 tmp;
                    Matrix3x3.Transform(ref positionLocalOffset, ref supportEntity.orientationMatrix, out tmp);
                    Vector3 worldSupportLocation; tmp.Add(ref supportEntity.position, out worldSupportLocation);
                    Vector3 error;
        ...
        public Vector3 RelativeWorldVelocity
        {
            get
            {
                ...
                {
                    Vector3 tmp;
                    Toolbox.GetVelocityOfPoint(ref supportData.Position, ref supportEntity.position, ref supportEntity.linearVelocity, ref supportEntity.angularVelocity, out tmp);
                    bodyVelocity.Sub(ref tmp, out tmp);
                    return tmp;
                }
                return bodyVelocity;
            }
        ...
        public Vector3 SupportVelocity
        {
            get
            {
                return supportEntity == null ? new Vector3() : Toolbox.GetVelocityOfPoint(ref supportData.Position, ref supportEntity.position, ref supportEntity.linearVelocity, ref supportEntity.angularVelocity);
            }
        }
