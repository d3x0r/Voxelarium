        ...
        public override void UpdateTimeOfImpact(Collidable requester, float dt)
        {
                ...
                )
            {
                ...
                if (minimumRadiusA * minimumRadiusA < velocitySquared)
                {
                    ...
                    RayHit rayHit;
					velocity.Invert( out velocity );
					Ray testRay = new Ray( ref convex.worldTransform.Position, ref velocity );
					if( GJKToolbox.CCDSphereCast(ref testRay, minimumRadiusA, triangle.Shape, ref triangle.worldTransform, timeOfImpact, out rayHit))
                    {
