...
namespace BEPUphysics.Constraints.SingleEntity
{
    ...
    public class SingleEntityLinearMotor : SingleEntityConstraint, I3DImpulseConstraintWithError
    {
		...
		/// </summary>
		public void GetRelativeVelocity( out Vector3 velocity )
        {
            Vector3.Cross(ref r, ref entity.angularVelocity, out velocity );
            Vector3.Subtract(ref velocity, ref entity.linearVelocity, out velocity );
        }
        ...
        /// </summary>
		public void GetError( out Vector3 result )
		{
			result = error;
		...
		public override float SolveIteration()
        {
            ...
            accumulatedImpulse.Add( ref lambda, out accumulatedImpulse );
            ...
            if (sumImpulseLengthSquared > maxForceDtSquared)
            {
                ...
                accumulatedImpulse.Mult( maxForceDt / (float)Math.Sqrt(sumImpulseLengthSquared), out accumulatedImpulse );

                //Since the limit was exceeded by this corrective impulse, limit it so that the accumulated impulse remains constrained.
                accumulatedImpulse.Sub( ref previousAccumulatedImpulse, out lambda );
            }
        ...
        public override void Update(float dt)
        {
            ...
            effectiveMassMatrix.M1.X += usedSoftness;
            effectiveMassMatrix.M2.Y += usedSoftness;
            effectiveMassMatrix.M3.Z += usedSoftness;
