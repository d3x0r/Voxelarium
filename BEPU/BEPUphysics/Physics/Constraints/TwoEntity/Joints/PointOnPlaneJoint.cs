...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class PointOnPlaneJoint : Joint, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public Vector3 LocalPlaneNormal
        {
            ...
            set
            {
                Vector3.Normalize(ref value, out localPlaneNormal);
        ...
        public Vector3 PlaneAnchor
        {
            ...
            set
            {
                ...
                value.Sub( ref connectionA.position, out localPlaneAnchor );
        ...
        public Vector3 PlaneNormal
        {
            ...
            set
            {
                Vector3.Normalize(ref value, out worldPlaneNormal );
        ...
        public Vector3 PointAnchor
        {
            ...
            set
            {
                ...
                value.Sub( ref connectionB.position, out localPointAnchor );
        ...
        {
			worldPlaneNormal.Invert( out jacobian );
        }
