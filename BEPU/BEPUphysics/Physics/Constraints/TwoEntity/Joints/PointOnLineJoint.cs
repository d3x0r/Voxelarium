...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class PointOnLineJoint : Joint, I2DImpulseConstraintWithError, I2DJacobianConstraint
    {
        ...
        public Vector3 LineAnchor
        {
            ...
            set
            {
                value.Sub( ref connectionA.position, out localAxisAnchor );
        ...
        public Vector3 LineDirection
        {
            ...
            set
            {
                Vector3.Normalize(ref value, out worldLineDirection);
        ...
        public Vector3 LocalLineDirection
        {
            ...
            set
            {
                Vector3.Normalize(ref value, out localLineDirection);
        ...
        public Vector3 Point
        {
            ...
            {
                worldPoint = value;
                worldPoint.Sub( ref connectionB.position, out localPoint );
        ...
        {
			worldRestrictedAxis1.Invert( out jacobianX );
			worldRestrictedAxis2.Invert( out jacobianY );
        }
        ...
        {
            Vector3.Cross(ref Vector3.Up, ref localLineDirection, out localRestrictedAxis1 );
            if (localRestrictedAxis1.LengthSquared() < .001f)
            {
                Vector3.Cross(ref Vector3.Right, ref localLineDirection, out localRestrictedAxis1 );
            }
            Vector3.Cross(ref localLineDirection, ref localRestrictedAxis1, out localRestrictedAxis2 );
