...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class SwivelHingeAngularJoint : Joint, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        /// The connected entities will be able to rotate around this axis relative to each other.</param>
        public SwivelHingeAngularJoint(Entity connectionA, Entity connectionB, ref Vector3 worldHingeAxis,ref Vector3 worldTwistAxis)
        {
        ...
        public Vector3 LocalHingeAxis
        {
            ...
            set
            {
                Vector3.Normalize(ref value, out localHingeAxis );
        ...
        public Vector3 LocalTwistAxis
        {
            ...
            set
            {
                Vector3.Normalize(ref value, out localTwistAxis );
        ...
        public Vector3 WorldHingeAxis
        {
            ...
            set
            {
                Vector3.Normalize(ref value, out worldHingeAxis);
        ...
        public Vector3 WorldTwistAxis
        {
            ...
            set
            {
                Vector3.Normalize(ref value, out worldTwistAxis);
                Quaternion conjugate;
