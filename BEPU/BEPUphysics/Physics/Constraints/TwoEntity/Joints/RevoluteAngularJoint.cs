...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class RevoluteAngularJoint : Joint, I2DImpulseConstraintWithError, I2DJacobianConstraint
    {
        ...
        public Vector3 LocalFreeAxisA
        {
            ...
            set
            {
                Vector3.Normalize(ref value, out localAxisA);
        ...
        public Vector3 LocalFreeAxisB
        {
            ...
            set
            {
                Vector3.Normalize( ref value, out localAxisB );
        ...
        public Vector3 WorldFreeAxisA
        {
            ...
            set
            {
                Vector3.Normalize(ref value, out worldAxisA );
        ...
        public Vector3 WorldFreeAxisB
        {
            ...
            set
            {
                Vector3.Normalize(ref value, out worldAxisB );
        ...
        {
            Vector3.Cross(ref Vector3.Up, ref localAxisA, out localConstrainedAxis1 );
            if (localConstrainedAxis1.LengthSquared() < .001f)
            {
                Vector3.Cross(ref Vector3.Right, ref localAxisA, out localConstrainedAxis1);
            }
            Vector3.Cross(ref localAxisA, ref localConstrainedAxis1, out localConstrainedAxis2);
        ...
        {
			worldConstrainedAxis1.Invert( out jacobianX );
			worldConstrainedAxis2.Invert( out jacobianY );
        }
