...
namespace BEPUphysics.Constraints.TwoEntity.Motors
{
    ...
    public class LinearAxisMotor : Motor, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public Vector3 AnchorA
        {
            ...
            {
                worldAnchorA = value;
                worldAnchorA.Sub( ref connectionA.position, out worldOffsetA );
        ...
        public Vector3 AnchorB
        {
            ...
            {
                worldAnchorB = value;
                worldAnchorB.Sub( ref connectionB.position, out worldOffsetB );
        ...
        public Vector3 Axis
        {
            ...
            set
            {
                Vector3.Normalize(ref value, out worldAxis);
        ...
        public Vector3 LocalAxis
        {
            ...
            set
            {
                Vector3.Normalize(ref value, out localAxis);
        ...
        public Vector3 LocalOffsetA
        {
            ...
            set
            {
                ...
                connectionA.position.Add( ref worldOffsetA, out worldAnchorA );
            }
        }
        ...
        public Vector3 LocalOffsetB
        {
            ...
            set
            {
                ...
                connectionB.position.Add( ref worldOffsetB, out worldAnchorB );
            }
        }
