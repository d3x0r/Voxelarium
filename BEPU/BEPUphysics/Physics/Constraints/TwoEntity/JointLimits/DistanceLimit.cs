    ...
    public class DistanceLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public Vector3 LocalAnchorA
        {
            ...
            set
            {
                ...
                anchorA.Add( ref connectionA.position, out anchorA );
            }
        }
        ...
        public Vector3 LocalAnchorB
        {
            ...
            set
            {
                ...
                anchorB.Add( ref connectionB.position, out anchorB );
            }
        }
        ...
        public Vector3 WorldAnchorA
        {
            ...
            set
            {
                anchorA = value;
				Vector3 tmp;
				anchorA.Sub( ref connectionA.position, out tmp );
        ...
        public Vector3 WorldAnchorB
        {
            ...
            set
            {
                anchorB = value;
				Vector3 tmp;
				anchorB.Sub( ref connectionB.position, out tmp );
				Quaternion.Transform( ref tmp, ref connectionB.conjOrientation, out localAnchorA );
			}
		}
