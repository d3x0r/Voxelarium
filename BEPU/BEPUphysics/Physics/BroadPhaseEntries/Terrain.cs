    ...
    public class Terrain : StaticCollidable
    {
        ...
        public AffineTransform WorldTransform
        {
            ...
            set
            {
                ...
                if (Vector3.Dot(ref normalTransform.M2, ref worldTransform.LinearTransform.M2) < 0)
                {
        ...
        public float Thickness
        {
            ...
            set
            {
                ...
                Vector3 tmp;
                worldTransform.LinearTransform.M2.Invert(out tmp);
                Vector3 down; Vector3.Normalize(ref tmp, out down);
                Vector3 thicknessOffset; down.Mult((value - thickness), out thicknessOffset);
        ...
        public override void UpdateBoundingBox()
        {
            ...
            worldTransform.LinearTransform.M2.Invert(out tmp);
            tmp.Normalize();
            Vector3 thicknessOffset; tmp.Mult(thickness, out thicknessOffset);
