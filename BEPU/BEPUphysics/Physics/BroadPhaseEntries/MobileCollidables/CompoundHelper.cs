...
namespace BEPUphysics.BroadPhaseEntries.MobileCollidables
{
    ...
    public static class CompoundHelper
    {
        ...
        static void SplitReposition(Entity a, Entity b, ref ShapeDistributionInformation distributionInfoA, ref ShapeDistributionInformation distributionInfoB, float weightA, float weightB)
        {
            ...
            Vector3 tmp;
            originalPosition.Add(ref offsetA, out tmp);
            a.Position = tmp;
            originalPosition.Add(ref offsetB, out tmp);
            b.Position = tmp;
            ...
            Vector3.Cross(ref originalAngularVelocity, ref offsetA, out tmp);
            tmp.Add(ref originalLinearVelocity, out tmp);
            a.LinearVelocity = tmp;
            Vector3.Cross(ref originalAngularVelocity, ref offsetB, out tmp);
            tmp.Add(ref originalLinearVelocity, out tmp);
            b.LinearVelocity = tmp;
        }
        ...
        static void RemoveReposition(Entity compound, ref ShapeDistributionInformation distributionInfo, float weight, float removedWeight, ref Vector3 removedCenter)
        {
            ...
            Vector3 tmp;
            originalPosition.Add(ref offset, out tmp);
            compound.Position = tmp;
            ...
            Vector3.Cross(ref originalAngularVelocity, ref offset, out tmp);
            originalLinearVelocity.Add(ref tmp, out tmp);
            compound.LinearVelocity = tmp;
        }
