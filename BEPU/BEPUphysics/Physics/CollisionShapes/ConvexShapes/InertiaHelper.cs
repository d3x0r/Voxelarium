...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public static class InertiaHelper
    {
        ...
        public static void GetPointContribution(float pointWeight, ref Vector3 center, ref Vector3 point, out Matrix3x3 contribution)
        {
            ...
            contribution.M1.X = yy + zz;
            contribution.M2.Y = xx + zz;
            contribution.M3.Z = xx + yy;
            contribution.M1.Y = -pointWeight * point.X * point.Y;
            contribution.M1.Z = -pointWeight * point.X * point.Z;
            contribution.M2.Z = -pointWeight * point.Y * point.Z;
            contribution.M2.X = contribution.M1.Y;
            contribution.M3.X = contribution.M1.Z;
            contribution.M3.Y = contribution.M2.Z;
        }
