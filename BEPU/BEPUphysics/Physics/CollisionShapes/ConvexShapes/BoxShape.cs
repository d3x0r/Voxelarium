    ...
    public class BoxShape : ConvexShape
    {
        ...
        public static ConvexShapeDescription ComputeDescription(float width, float height, float length, float collisionMargin)
        {
			...
			description.EntityShapeVolume.VolumeDistribution = new Matrix3x3(
				 ( heightSquared + lengthSquared ) * inv12,
				 ( widthSquared + lengthSquared ) * inv12,
				 ( widthSquared + heightSquared ) * inv12 );
        ...
        public override void GetBoundingBox(ref RigidTransform shapeTransform, out BoundingBox boundingBox)
        {
            ...
            var right = new Vector3(Math.Sign(o.M1.X) * halfWidth, Math.Sign(o.M2.X ) * halfHeight, Math.Sign(o.M3.X ) * halfLength);

            var up = new Vector3(Math.Sign(o.M1.Y) * halfWidth, Math.Sign(o.M2.Y ) * halfHeight, Math.Sign(o.M3.Y ) * halfLength);

            var backward = new Vector3(Math.Sign(o.M1.Z ) * halfWidth, Math.Sign(o.M2.Z ) * halfHeight, Math.Sign(o.M3.Z) * halfLength);
