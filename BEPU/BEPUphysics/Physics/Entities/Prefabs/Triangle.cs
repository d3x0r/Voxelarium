...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class Triangle : Entity<ConvexCollidable<TriangleShape>>
    {
        ...
        public Vector3 VertexA
        {
            ...
            {
				Vector3 tmp;
				Matrix3x3.Transform( ref CollisionInformation.Shape.vA, ref orientationMatrix, out tmp );
				tmp.Add( ref position, out tmp );
                return tmp;
            ...
            {
				Vector3 tmp;
				value.Sub( ref position, out tmp );
				Vector3 va;
				Matrix3x3.TransformTranspose( ref tmp, ref orientationMatrix, out va );
                CollisionInformation.Shape.VertexA = va;
            }
        }
        ///<summary>
        ...
        public Vector3 VertexB
        {
            ...
            {
				Vector3 tmp;
				Matrix3x3.Transform(ref CollisionInformation.Shape.vB, ref orientationMatrix, out tmp );
				tmp.Add( ref position, out tmp );
				return tmp;
            }
            set
            {
				...
				value.Sub( ref position, out tmp );
				Vector3 vb;
				Matrix3x3.TransformTranspose( ref tmp, ref orientationMatrix, out vb );
                CollisionInformation.Shape.VertexB = vb;
            }
        }
        ///<summary>
        ...
        public Vector3 VertexC
        {
            ...
            {
				Vector3 tmp;
				Matrix3x3.Transform( ref CollisionInformation.Shape.vC, ref orientationMatrix, out tmp );
				tmp.Add( ref position, out tmp );
				return tmp;
            }
            set
            {
				...
				value.Sub( ref position, out tmp );
				Vector3 newv;
				Matrix3x3.TransformTranspose( ref tmp, ref orientationMatrix, out newv );
				CollisionInformation.Shape.VertexC = newv;
            }
        }
