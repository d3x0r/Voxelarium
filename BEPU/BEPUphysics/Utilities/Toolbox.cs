...
namespace BEPUutilities
{
    ...
    public static class Toolbox
    {
        ...
        public static bool GetSegmentPlaneIntersection(ref Vector3 a, ref Vector3 b, ref Vector3 d, ref Vector3 e, ref Vector3 f, out Vector3 q)
        {
            Plane p;
            Vector3.CrossDiff2(ref e, ref d, ref f, ref d, out p.Normal);
            p.D = Vector3.Dot(ref p.Normal, ref d);
            float t;
            return GetSegmentPlaneIntersection(ref a, ref b, ref p, out t, out q);
        }
        ...
        /// <param name="q">Intersection point.</param>
        /// <returns>Whether or not the segment intersects the plane.</returns>
        public static bool GetSegmentPlaneIntersection( ref Vector3 a, ref Vector3 b, ref Plane p, out Vector3 q )
        {
            float t;
        ...
        /// <param name="q">Intersection point.</param>
        /// <returns>Whether or not the segment intersects the plane.</returns>
        public static bool GetSegmentPlaneIntersection( ref Vector3 a, ref Vector3 b, ref Plane p, out float t, out Vector3 q)
        {
            return GetLinePlaneIntersection(ref a, ref b, ref p, out t, out q) && t >= 0 && t <= 1;
        }
        ...
        public static void GetClosestPointOnTetrahedronToPoint(RawList<Vector3> tetrahedron, ref Vector3 p, RawList<int> subsimplex, RawList<float> baryCoords, out Vector3 closestPoint)
        {
            ...
            if (!baryCoordsFound)
            {
                ...
                float abcd = (new Matrix(tetrahedron[0].X, tetrahedron[0].Y, tetrahedron[0].Z, 1,
                                         ...
                                         tetrahedron[3].X, tetrahedron[3].Y, tetrahedron[3].Z, 1)).DeterminantAllPos();
        ...
        public static bool RayCastSphere(ref Ray ray, ref Vector3 spherePosition, float radius, float maximumLength, out RayHit hit)
        {
            ...
            float b = Vector3.Dot( ref m, ref normalizedDirection );
        ...
        public static Vector3 GetVelocityOfPoint(ref Vector3 point, ref Vector3 center, ref Vector3 linearVelocity, ref Vector3 angularVelocity )
        {
            Vector3 toReturn;
