...
namespace BEPUik
{
    ...
    public class Bone
    {
        ...
        /// Gets or sets the orientation of the bone.
        /// </summary>
        public Quaternion ConjOrientation = Quaternion.Identity;
        ...
        void ComputeLocalInertiaTensor()
        {
            ...
            localInertiaTensor.M1.X = diagValue;
            localInertiaTensor.M2.Y = .5f * Radius * Radius * multiplier;
            localInertiaTensor.M3.Z = diagValue;
