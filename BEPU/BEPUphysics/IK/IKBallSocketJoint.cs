...
namespace BEPUik
{
    ...
    public class IKBallSocketJoint : IKJoint
    {
        ...
        /// </summary>
        public void SetOffsetA(ref Vector3 a)
        {
            Quaternion.Transform(ref a, ref ConnectionA.ConjOrientation, out LocalOffsetA);
        }

        /// <summary>
        /// Sets the offset in world space from the center of mass of connection A to the anchor point.
        /// </summary>
        public void SetOffsetB(ref Vector3 a)
        {
            Quaternion.Transform(ref a, ref ConnectionB.ConjOrientation, out LocalOffsetB);
        }
        ...
        protected internal override void UpdateJacobiansAndVelocityBias()
        {
            ...
            linearJacobianB = new Matrix3x3(-1, -1, -1);
            Vector3 rA;
