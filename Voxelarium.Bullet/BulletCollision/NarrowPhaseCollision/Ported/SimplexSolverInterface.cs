...
namespace Bullet.Collision.NarrowPhase
{
	...
	public interface btSimplexSolverInterface
	{

		void reset();

		void addVertex( ref btVector3 w, ref btVector3 p, ref btVector3 q );
		...
		void compute_points( out btVector3 p1, out btVector3 p2 );
