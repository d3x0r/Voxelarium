...
///2014 Oct, Erwin Coumans, Use templates to avoid object casts

#if ! BT_MPR_PENETRATION_H
...
struct btMprCollisionDescription
{
    ...
    double	m_maximumDistanceSquared;
    double	m_gjkRelError2;
...
inline int btMprSimplexSize(btMprSimplex_t *s)
{
    return s.last + 1;
}


inline btMprSupport_t* btMprSimplexPoint(btMprSimplex_t* s, int idx)
{
    // here is no check on boundaries
    return &s.ps[idx];
}

inline void btMprSupportCopy(btMprSupport_t *d, btMprSupport_t *s)
{
    *d = *s;
}

inline void btMprSimplexSet(btMprSimplex_t *s, size_t pos, btMprSupport_t *a)
{
...
inline int btMprVec3Eq(btVector3* a, btVector3 *b)
{
...
inline void btFindOrigin(btConvexTemplate& a, btConvexTemplate& b, btMprCollisionDescription& colDesc,btMprSupport_t *center)
{
...
inline void btMprVec3Add(btVector3 *v, btVector3 *w)
{
	*v += *w;
}

inline void btMprVec3Copy(btVector3 *v, btVector3 *w)
{
    *v = *w;
}
...
inline float btMprVec3Dot(btVector3 *a, btVector3 *b)
{
    float dot;
...
inline float btMprVec3Len2(btVector3 *v)
{
...
{
    float k = 1 / BT_MPR_SQRT(btMprVec3Len2(d));
    btMprVec3Scale(d, k);
}

inline void btMprVec3Cross(btVector3 *d, btVector3 *a, btVector3 *b)
{
	*d = btCross(*a,*b);
...
inline void btMprVec3Sub2(btVector3 *d, btVector3 *v, btVector3 *w)
{
	*d = *v - *w;
}

inline void btPortalDir(btMprSimplex_t *portal, btVector3 *dir)
{
    btVector3 v2v1, v3v1;
...
inline int portalEncapsulesOrigin(btMprSimplex_t *portal,
                                       btVector3 *dir)
{
    float dot;
    dot = btMprVec3Dot(dir, &btMprSimplexPoint(portal, 1).v);
    return btMprIsZero(dot) || dot > 0;
}

inline int portalReachTolerance(btMprSimplex_t *portal,
                                     btMprSupport_t *v4,
                                     btVector3 *dir)
{
...
inline int portalCanEncapsuleOrigin(btMprSimplex_t *portal,
                                         btMprSupport_t *v4,
                                         btVector3 *dir)
{
    float dot;
...
template <typename btConvexTemplate>
inline void btMprSupport(btConvexTemplate& a, btConvexTemplate& b,
                         btMprCollisionDescription& colDesc,
													ref btVector3 dir, btMprSupport_t *supp)
{
...
template <typename btConvexTemplate>
static int btDiscoverPortal(btConvexTemplate& a, btConvexTemplate& b,
                            btMprCollisionDescription& colDesc,
													btMprSimplex_t *portal)
{
    ...
    if (btMprVec3Eq(&btMprSimplexPoint(portal, 0).v, org)){
        ...
        btMprVec3Set(&va, FLT_EPSILON * 10.f, 0, 0);
...
template <typename btConvexTemplate>
static int btRefinePortal(btConvexTemplate& a, btConvexTemplate& b,btMprCollisionDescription& colDesc,
							btMprSimplex_t *portal)
{
    btVector3 dir;
    btMprSupport_t v4;
...
static void btFindPos(btMprSimplex_t *portal, btVector3 *pos)
{
    ...
    btMprVec3Cross(&vec, &btMprSimplexPoint(portal, 1).v,
                       &btMprSimplexPoint(portal, 2).v);
    b = btMprVec3Dot(&vec, &btMprSimplexPoint(portal, 3).v);
...
#if MPR_AVERAGE_CONTACT_POSITIONS
...
inline float btMprVec3Dist2(btVector3 *a, btVector3 *b)
{
    btVector3 ab;
...
inline float _btMprVec3PointSegmentDist2(btVector3 *P,
                                                  btVector3 *x0,
                                                  btVector3 *b,
                                                  btVector3 *witness)
{
    ...
    t  = -1 * btMprVec3Dot(&a, &d);
    t /= btMprVec3Len2(&d);

    if (t < 0 || btMprIsZero(t)){
        dist = btMprVec3Dist2(x0, P);
        if (witness)
            btMprVec3Copy(witness, x0);
    }else if (t > 1 || btMprEq(t, 1)){
...
inline float btMprVec3PointTriDist2(btVector3 *P,
                                btVector3 *x0, btVector3 *B,
                                btVector3 *C,
                                btVector3 *witness)
{
...
template <typename btConvexTemplate>
static void btFindPenetr(btConvexTemplate& a, btConvexTemplate& b,
                         btMprCollisionDescription& colDesc,
                         btMprSimplex_t *portal,
...
template <typename btConvexTemplate>
inline int btMprPenetration( btConvexTemplate& a, btConvexTemplate& b,
                            btMprCollisionDescription& colDesc,
...
inline int	btComputeMprPenetration( btConvexTemplate& a, btConvexTemplate& b, const
