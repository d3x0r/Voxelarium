#if ! BT_BASIC_GEOMETRY_OPERATIONS_H_INCLUDED
...
public void bt_edge_plane(btVector3  e1,btVector3   e2, btVector3  normal,btVector4  plane)
{
	btVector3 planenormal = (e2-e1).cross(normal);
	planenormal.normalize();
	plane.setValue(planenormal,planenormal[1],planenormal[2],e2.dot(planenormal));
}
 ...
 */
public void bt_closest_point_on_segment(
	btVector3  cp, btVector3  v,
	btVector3  e1,btVector3 e2)
{
    btVector3 n = e2-e1;
    cp = v - e1;
...
public int bt_line_plane_collision(
	btVector4 & plane,
	btVector3  vDir,
	btVector3  vPoint,
	btVector3  pout,
	...
	double tmin, double tmax)
{
	...
	double _dis = bt_distance_point_plane(plane,vPoint);
...
public void bt_segment_collision(
	btVector3  vA1,
	btVector3  vA2,
	btVector3  vB1,
	btVector3  vB2,
	...
	btVector3  vPointB)
{
    ...
    bt_line_plane_collision(_M,AD,vA1,vPointA,tp,(double)(0), (double)(1));
