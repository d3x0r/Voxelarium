...
public double bt_distance_point_plane(btVector4 & plane,btVector3 point)
{
...
public void bt_vec_blend(btVector3 vr, btVector3 va,btVector3 vb, double blend_factor)
{
	vr = (1-blend_factor)*va + blend_factor*vb;
}

//! This function calcs the distance from a 3D plane
public void bt_plane_clip_polygon_collect(
						btVector3  point0,
						btVector3  point1,
						double dist0,
						double dist1,
...
*/
public int bt_plane_clip_polygon(
						btVector4  plane,
						...
						btVector3 * clipped)
{
    ...
    //clip first point
	double firstdist = bt_distance_point_plane(plane,polygon_points);;
	...
	{
		double dist = bt_distance_point_plane(plane,polygon_points[i]);
...
*\return The count of the clipped counts
*/
public int bt_plane_clip_triangle(
						btVector4 & plane,
						btVector3  point0,
						btVector3  point1,
						ref btVector3 point2,
						...
						)
{
    ...
    //clip first point0
	double firstdist = bt_distance_point_plane(plane,point0);;
	if(!(firstdist>SIMD_EPSILON))
	{
	...
	// point 1
	double olddist = firstdist;
	double dist = bt_distance_point_plane(plane,point1);
