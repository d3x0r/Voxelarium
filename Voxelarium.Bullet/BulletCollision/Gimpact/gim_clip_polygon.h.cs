#if ! GIM_CLIP_POLYGON_H_INCLUDED
...
public:
	...
	inline GREAL operator()(string LASS_PLANE & plane, string LASS_POINT & point)
	{
...
public void PLANE_CLIP_POLYGON_COLLECT(
						string LASS_POINT & point0,
						string LASS_POINT & point1,
						GREAL dist0,
						GREAL dist1,
						CLASS_POINT * clipped,
						GUINT & clipped_count)
...
public GUINT PLANE_CLIP_POLYGON_GENERIC(
						string LASS_PLANE  plane,
						string LASS_POINT * polygon_points,
						...
						CLASS_POINT * clipped,DISTANCE_PLANE_FUNC distance_func)
{
    ...
    //clip first point
	GREAL firstdist = distance_func(plane,polygon_points);;
...
*/
template<typename CLASS_POINT,typename CLASS_PLANE, typename DISTANCE_PLANE_FUNC>
public GUINT PLANE_CLIP_TRIANGLE_GENERIC(
						string LASS_PLANE & plane,
						string LASS_POINT & point0,
						string LASS_POINT & point1,
						string LASS_POINT & point2,
						CLASS_POINT * clipped,DISTANCE_PLANE_FUNC distance_func)
{
    GUINT clipped_count = 0;
...
template<typename CLASS_POINT,typename CLASS_PLANE>
public GUINT PLANE_CLIP_POLYGON3D(
						string LASS_PLANE & plane,
						string LASS_POINT * polygon_points,
						GUINT polygon_point_count,
						CLASS_POINT * clipped)
...
template<typename CLASS_POINT,typename CLASS_PLANE>
public GUINT PLANE_CLIP_TRIANGLE3D(
						string LASS_PLANE & plane,
						string LASS_POINT & point0,
						string LASS_POINT & point1,
						string LASS_POINT & point2,
