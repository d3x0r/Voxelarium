...
#define pfval2	128
//! Prefetch 64
#define pf(_x,_i)	_mm_prefetch((object )(_x + _i + pfval), 0)
//! Prefetch 128
#define pf2(_x,_i)	_mm_prefetch((object )(_x + _i + pfval2), 0)
#else
//! Prefetch 64
#define pf(_x,_i)
//! Prefetch 128
...
typedef object  gim_alloc_function (size_t size);
typedef object  gim_alloca_function (size_t size);//Allocs on the heap
typedef object  gim_realloc_function (object ptr, size_t oldsize, size_t newsize);
typedef void gim_free_function (object ptr);
...
object  gim_alloc(size_t size);
object  gim_alloca(size_t size);
object  gim_realloc(object ptr, size_t oldsize, size_t newsize);
void gim_free(object ptr);
...
inline void gim_simd_memcpy(object  dst, object  src, size_t copysize)
{
#if GIM_SIMD_MEMORY
/*
