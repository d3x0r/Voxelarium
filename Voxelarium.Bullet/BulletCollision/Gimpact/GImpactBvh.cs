...
bool btGImpactBvh::boxQuery(btAABB & box, btList<int> & collided_results)
{
	int curIndex = 0;
...
void btGImpactBvh::find_collision(btGImpactBvh * boxset0, btTransform & trans0,
		btGImpactBvh * boxset1, btTransform & trans1,
		btPairSet & collision_pairs)
{
