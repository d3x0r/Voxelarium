...
public:
    ...
    public void interpolate_normals( btVector3 * normals,GUINT normal_count)
    {
...
public:
	...
	public void push_contact(btVector3 point,btVector3  normal,
    	 			GREAL depth, GUINT feature1, GUINT feature2)
	{
		push_back_mem();
	...
	public void push_triangle_contacts(
		string IM_TRIANGLE_CONTACT_DATA & tricontact,
	...
	void merge_contacts(string im_contact_array & contacts, bool normal_contact_average = true);
	void merge_contacts_unique(string im_contact_array & contacts);
};
