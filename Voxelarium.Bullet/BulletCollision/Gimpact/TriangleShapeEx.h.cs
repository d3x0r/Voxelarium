...
#if ! GIMPACT_TRIANGLE_SHAPE_EX_H
...
struct GIM_TRIANGLE_CONTACT
{
	...
	public void copy_from(string IM_TRIANGLE_CONTACT& other)
	{
	...
	GIM_TRIANGLE_CONTACT(string IM_TRIANGLE_CONTACT& other)
	{
		copy_from(other);
	}

    //! classify points that are closer
    void merge_points(btVector4 & plane,
...
public:
	...
	bool overlap_test_conservative(btPrimitiveTriangle& other);

	//! Calcs the plane which is paralele to the edge and perpendicular to the triangle plane
	/*!
	\pre this triangle must have its plane calculated.
	*/
	public void get_edge_plane(int edge_index, btVector4 &plane)  const
    {
    ...
    void applyTransform(ref btTransform t)
	{
...
public:
	...
	btTriangleShapeEx(ref btVector3 p0,ref btVector3 p1,ref btVector3 p2):	btTriangleShape(p0,p1,p2)
	{
	}

	btTriangleShapeEx(btTriangleShapeEx & other):	btTriangleShape(other.m_vertices1,other.m_vertices1[1],other.m_vertices1[2])
	{
	}

	virtual void getAabb(ref btTransform t,ref btVector3 aabbMin,ref btVector3 aabbMax)const
	{
	...
	bool overlap_test_conservative(btTriangleShapeEx& other);
};
