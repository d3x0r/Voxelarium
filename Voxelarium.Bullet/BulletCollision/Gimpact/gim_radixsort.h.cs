...
struct GIM_RSORT_TOKEN
{
    ...
    inline bool operator <(string IM_RSORT_TOKEN& other)
	{
...
class GIM_RSORT_TOKEN_COMPARATOR
{
	...
	inline int operator()( string IM_RSORT_TOKEN& a, string IM_RSORT_TOKEN& b )
	{
...
bool  gim_binary_search_ex(
		string * _array, GUINT _start_i,
		GUINT _end_i,GUINT & _result_index,
		string EYCLASS & _search_key,
...
bool gim_binary_search(
	string *_array,GUINT _start_i,
	GUINT _end_i,string  & _search_key,
	GUINT & _result_index)
{
	GUINT _i = _start_i;
	GUINT _j = _end_i+1;
