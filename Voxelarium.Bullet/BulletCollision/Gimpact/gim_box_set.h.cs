...
public:
	...
	//! node count
	public GUINT getNodeCount()
	{
		return m_num_nodes;
	}

	//! tells if the node is a leaf
	public bool isLeafNode(GUINT nodeindex)
	{
		return m_node_array[nodeindex].is_leaf_node();
	}

	public GUINT getNodeData(GUINT nodeindex)
	{
		return m_node_array[nodeindex].m_data;
	}

	public void getNodeBound(GUINT nodeindex, GIM_AABB & bound)
	{
		bound = m_node_array[nodeindex].m_bound;
	}

	public void setNodeBound(GUINT nodeindex, string IM_AABB & bound)
	{
		m_node_array[nodeindex].m_bound = bound;
	}

	public GUINT getLeftNodeIndex(GUINT nodeindex)  const
	{
		return m_node_array[nodeindex].m_left;
	}

	public GUINT getRightNodeIndex(GUINT nodeindex)  const
	{
		return m_node_array[nodeindex].m_right;
	}

	public GUINT getScapeNodeIndex(GUINT nodeindex)
	{
...
public:
	...
	public GIM_AABB getGlobalBox()  const
	{
		GIM_AABB totalbox;
	...
	public void setPrimitiveManager(string GIM_PRIMITIVE_MANAGER_PROTOTYPE & primitive_manager)
	{
		m_primitive_manager = primitive_manager;
	}

	string GIM_PRIMITIVE_MANAGER_PROTOTYPE & getPrimitiveManager()
	{
...
///@{
	...
	public void buildSet()
	{
		...
		for (GUINT i = 0;i<primitive_boxes.Count ;i++ )
		{
	...
	public bool boxQuery(string IM_AABB  box, gim_array<GUINT> & collided_results)
	{
		GUINT curIndex = 0;
	...
	//! returns the indices of the primitives in the m_primitive_manager
	public bool boxQueryTrans(string IM_AABB & box,
		 btTransform & transform, gim_array<GUINT> & collided_results)
	{
	...
	public void getNodeBound(GUINT nodeindex, GIM_AABB & bound)  const
	{
	...
	public GUINT getLeftNodeIndex(GUINT nodeindex)
	{
		return m_box_tree.getLeftNodeIndex(nodeindex);
	}

	public GUINT getRightNodeIndex(GUINT nodeindex)
	{
	...
	public void getNodeTriangle(GUINT nodeindex,GIM_TRIANGLE & triangle)
	{
...
protected:
	public void retrieve_node0_triangle(GUINT node0)
	{
		if(node0_has_triangle) return;
		m_boxset0.getNodeTriangle(node0,m_tri0);
		//transform triangle
		m_tri0.m_vertices = trans_cache_0to1(m_tri0.m_vertices[0]);
	...
	public void retrieve_node1_triangle(GUINT node1)
	{
	...
	public void retrieve_node0_info(GUINT node0)
	{
	...
	public void retrieve_node1_info(GUINT node1)
	{
	...
	public bool node_collision(GUINT node0 ,GUINT node1)
	{
		...
		if(t0_is_trimesh & node0_is_leaf)
		{
			...
			result = m_box1.collide_triangle_exact(
				m_tri0.m_vertices,m_tri0.m_vertices[1],m_tri0.m_vertices[2],m_tri0_plane);
		...
		else if(t1_is_trimesh & node1_is_leaf)
		{
			...
			result = m_box0.collide_triangle_exact(
				m_tri1.m_vertices,m_tri1.m_vertices[1],m_tri1.m_vertices[2],m_tri1_plane);
...
public:
	void find_collision(BOX_SET_CLASS0 * boxset1, btTransform & trans1,
		BOX_SET_CLASS1 * boxset2, btTransform & trans2,
