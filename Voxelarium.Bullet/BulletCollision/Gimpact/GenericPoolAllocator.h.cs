...
#if ! BT_GENERIC_POOL_ALLOCATOR_H
...
{
public:
	byte * m_pool; //[m_element_size*m_max_element_count];
...
public:
	...
	inline object  get_element_data(size_t element_index)
	{
	...
	*/
	object  allocate(size_t size_bytes);

	bool freeMemory(object  pointer);
};
...
protected:
	...
	object  failback_alloc(size_t size_bytes);

	bool failback_free(object  pointer);
public:
