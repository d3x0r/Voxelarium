...
#if ! BT_CONVEX_2D_CONVEX_2D_ALGORITHM_H
...
public:
	...
	btConvex2dConvex2dAlgorithm(btPersistentManifold* mf,btCollisionAlgorithmConstructionInfo& ci,btCollisionObjectWrapper* body0Wrap,btCollisionObjectWrapper* body1Wrap, btSimplexSolverInterface* simplexSolver, btConvexPenetrationDepthSolver* pdSolver, int numPerturbationIterations, int minimumPointsPerturbationThreshold);
	...
	struct CreateFunc :public 	btCollisionAlgorithmCreateFunc
	{
		...
		{
			object mem = ci.m_dispatcher1.allocateCollisionAlgorithm(sizeof(btConvex2dConvex2dAlgorithm));
