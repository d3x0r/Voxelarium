...
btBox2dBox2dCollisionAlgorithm::btBox2dBox2dCollisionAlgorithm(btPersistentManifold* mf,btCollisionAlgorithmConstructionInfo& ci,btCollisionObjectWrapper* obj0Wrap,btCollisionObjectWrapper* obj1Wrap)
...
void b2CollidePolygons(btManifoldResult* manifold,  btBox2dShape* polyA, ref btTransform xfA, btBox2dShape* polyB, ref btTransform xfB);

//#include <stdio.h>
void btBox2dBox2dCollisionAlgorithm::processCollision (btCollisionObjectWrapper* body0Wrap,btCollisionObjectWrapper* body1Wrap,btDispatcherInfo& dispatchInfo,btManifoldResult* resultOut)
{
	if (!m_manifoldPtr)
		return;

	
	btBox2dShape* box0 = (btBox2dShape*)body0Wrap.getCollisionShape();
	btBox2dShape* box1 = (btBox2dShape*)body1Wrap.getCollisionShape();
...
#define btCrossS(a,s) btVector3(s * a.y, -s * a.x,0)

int b2_maxManifoldPoints =2;

static int ClipSegmentToLine(ClipVertex vOut[2], ClipVertex vIn[2],
					  ref btVector3 normal, double offset)
{
...
static double EdgeSeparation(btBox2dShape* poly1, ref btTransform xf1, int edge1,
							  btBox2dShape* poly2, ref btTransform xf2)
{
	btVector3* vertices1 = poly1.getVertices();
	btVector3* normals1 = poly1.getNormals();

	int count2 = poly2.getVertexCount();
	btVector3* vertices2 = poly2.getVertices();
	...
	double separation = b2Dot(v2 - v1, normal1World);
	return separation;
}

// Find the max separation between poly1 and poly2 using edge normals from poly1.
static double FindMaxSeparation(int* edgeIndex,
								 btBox2dShape* poly1, ref btTransform xf1,
								 btBox2dShape* poly2, ref btTransform xf2)
{
...
static void FindIncidentEdge(ClipVertex c[2],
							 btBox2dShape* poly1, ref btTransform xf1, int edge1,
							 btBox2dShape* poly2, ref btTransform xf2)
{
	btVector3* normals1 = poly1.getNormals();
	...
	int count2 = poly2.getVertexCount();
	btVector3* vertices2 = poly2.getVertices();
	btVector3* normals2 = poly2.getNormals();
...
void b2CollidePolygons(btManifoldResult* manifold,
					  btBox2dShape* polyA, ref btTransform xfA,
					  btBox2dShape* polyB, ref btTransform xfB)
{
	...
	btBox2dShape* poly1;	// reference poly
	btBox2dShape* poly2;	// incident poly
	btTransform xf1, xf2;
	...
	{
		double separation = b2Dot(frontNormal, clipPoints2[i].v) - frontOffset;

		if (separation <= 0.0f)
		{
			
			//b2ManifoldPoint* cp = manifold.points + pointCount;
			//double separation = separation;
