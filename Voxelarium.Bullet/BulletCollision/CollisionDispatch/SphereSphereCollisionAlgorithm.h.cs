...
public:
	btSphereSphereCollisionAlgorithm(btPersistentManifold* mf,btCollisionAlgorithmConstructionInfo& ci,btCollisionObjectWrapper* col0Wrap,btCollisionObjectWrapper* col1Wrap);
	...
	struct CreateFunc :public 	btCollisionAlgorithmCreateFunc
	{
		...
		{
			object mem = ci.m_dispatcher1.allocateCollisionAlgorithm(sizeof(btSphereSphereCollisionAlgorithm));
