...
#if ! BT_BOX_2D_BOX_2D__COLLISION_ALGORITHM_H
...
public:
	btBox2dBox2dCollisionAlgorithm(btCollisionAlgorithmConstructionInfo& ci)
	...
	btBox2dBox2dCollisionAlgorithm(btPersistentManifold* mf,btCollisionAlgorithmConstructionInfo& ci,btCollisionObjectWrapper* body0Wrap,btCollisionObjectWrapper* body1Wrap);
	...
	struct CreateFunc :public 	btCollisionAlgorithmCreateFunc
	{
		virtual	btCollisionAlgorithm* CreateCollisionAlgorithm(btCollisionAlgorithmConstructionInfo& ci, btCollisionObjectWrapper* body0Wrap,btCollisionObjectWrapper* body1Wrap)
		{
			...
			object ptr = ci.m_dispatcher1.allocateCollisionAlgorithm(bbsize);
