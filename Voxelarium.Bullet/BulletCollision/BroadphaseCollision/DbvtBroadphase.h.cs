...
struct btDbvtProxy : btBroadphaseProxy
{
	...
	int				stage;
	/* ctor			*/ 
	btDbvtProxy(ref btVector3 aabbMin,ref btVector3 aabbMax,object userPtr,short int collisionFilterGroup, short int collisionFilterMask) :
...
typedef btList<btDbvtProxy*>	btDbvtProxyArray;
...
struct	btDbvtBroadphase : btBroadphaseInterface
{
	...
	btBroadphaseProxy*				createProxy(ref btVector3 aabbMin,ref btVector3 aabbMax,int shapeType,object userPtr,short int collisionFilterGroup,short int collisionFilterMask,btDispatcher* dispatcher,object multiSapProxy);
	...
	void							setAabbForceUpdate(		btBroadphaseProxy* absproxy,ref btVector3 aabbMin,ref btVector3 aabbMax,btDispatcher* /*dispatcher*/);
