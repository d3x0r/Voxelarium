...
btMultiSphereShape::btMultiSphereShape (btVector3* positions,double* radi,int numSpheres)
...
#endif
 btVector3	btMultiSphereShape::localGetSupportingVertexWithoutMargin(ref btVector3 vec0)const
{
	btVector3 supVec(0,0,0);

	double maxDot((double)(-BT_LARGE_FLOAT));
	...
	btVector3* pos = m_localPositionArray;
	double* rad = m_radiArray;
 ...
 void	btMultiSphereShape::batchedUnitVectorGetSupportingVertexWithoutMargin(btVector3* vectors,btVector3* supportVerticesOut,int numVectors)
{
...
void	btMultiSphereShape::calculateLocalInertia(double mass,ref btVector3 inertia)
{
