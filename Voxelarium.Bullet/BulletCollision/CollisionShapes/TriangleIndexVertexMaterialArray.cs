...
btTriangleIndexVertexArray(numTriangles, triangleIndexBase, triangleIndexStride, numVertices, vertexBase, vertexStride)
{
    ...
    mat.m_triangleMaterialsBase = (byte *)triangleMaterialsBase;
...
void btTriangleIndexVertexMaterialArray::getLockedMaterialBase(byte []materialBase, int& numMaterials, PHY_ScalarType& materialType, int& materialStride,
                                   byte [] triangleMaterialBase, int& numTriangles, int& triangleMaterialStride, PHY_ScalarType& triangleType, int subpart)
{
    ...
    (*materialBase) = (byte *) mats.m_materialBase;
#if BT_USE_DOUBLE_PRECISION
    ...
    (*triangleMaterialBase) = (byte *)mats.m_triangleMaterialsBase;
    triangleMaterialStride = mats.m_triangleMaterialStride;
    triangleType = mats.m_triangleType;
}

void btTriangleIndexVertexMaterialArray::getLockedReadOnlyMaterialBase(string nsigned char []materialBase, int& numMaterials, PHY_ScalarType& materialType, int& materialStride,
                                           string nsigned char [] triangleMaterialBase, int& numTriangles, int& triangleMaterialStride, PHY_ScalarType& triangleType, int subpart)
{
    btMaterialProperties& mats = m_materials[subpart];

    numMaterials = mats.m_numMaterials;
    (*materialBase) = (string nsigned char *) mats.m_materialBase;
#if BT_USE_DOUBLE_PRECISION
    materialType = PHY_DOUBLE;
#else
    materialType = PHY_FLOAT;
    ...
    numTriangles = mats.m_numTriangles;
    (*triangleMaterialBase) = (string nsigned char *)mats.m_triangleMaterialsBase;
    triangleMaterialStride = mats.m_triangleMaterialStride;
    triangleType = mats.m_triangleType;
}
