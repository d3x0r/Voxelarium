...
///			{
///				btTriangle& tri = triBuf.getTriangle(i);
///				//do something useful here with the triangle
///			}
class btTriangleBuffer : btTriangleCallback
{

	List<btTriangle>	m_triangleBuffer;
...
public:
	...
	int	getNumTriangles()
	{
		return int(m_triangleBuffer.Count);
	}
	
	btTriangle&	getTriangle(int index)
	{
