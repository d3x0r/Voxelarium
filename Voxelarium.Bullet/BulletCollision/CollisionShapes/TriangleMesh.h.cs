...
{
	List<btVector3>	m_4componentVertices;
	List<double>	m_3componentVertices;

	List<uint>		m_32bitIndices;
	List<ushort int>		m_16bitIndices;
	bool	m_use32bitIndices;
	bool	m_use4componentVertices;
	

	public:
		double	m_weldingThreshold;
		...
		bool	getUse4componentVertices()
		{
			return m_use4componentVertices;
		}
		///By default addTriangle won't search for duplicate vertices, because the search is very slow for large triangle meshes.
		///In general it is better to directly use btTriangleIndexVertexArray instead.
		void	addTriangle(ref btVector3 vertex0,ref btVector3 vertex1,ref btVector3 vertex2, bool removeDuplicateVertices=false);
		...
		int		findOrAddVertex(ref btVector3 vertex, bool removeDuplicateVertices);
