...
btMaterial * btMultimaterialTriangleMeshShape::getMaterialProperties(int partID, int triIndex)
{
    string nsigned char * materialBase = 0;
    int numMaterials;
    PHY_ScalarType materialType;
    int materialStride;
    string nsigned char * triangleMaterialBase = 0;
    int numTriangles;
    ...
    // BUG IN GIMPACT
    //return (double*)(&materialBase[triangleMaterialBase[(triIndex-1) * triangleMaterialStride] * materialStride]);
