...
namespace Bullet.Collision.Shapes
{
	...
	internal class NodeArray<Index, Data> : btList<btOptimizedBvhNode<Index, Data>> { }
	...
	public class btOptimizedBvh<Index, Data> : btQuantizedBvh
	{
		...
		internal struct NodeTriangleCallback : btInternalTriangleIndexCallback
		{
		...
		*/
			internal NodeTriangleCallback()
			{
			}

			internal void Initialize( NodeArray triangleNodes )
			{
				m_triangleNodes = triangleNodes;
			}

			internal NodeTriangleCallback( NodeArray triangleNodes )
		...
		struct QuantizedNodeTriangleCallback : btInternalTriangleIndexCallback
		{
			...
			virtual void internalProcessTriangleIndex( ref btVector3 triangle, int partId, int triangleIndex )
			{
		...
		public void updateBvhNodes( btStridingMeshInterface meshInterface, int firstNode, int endNode, int index )
		{
			...
			btVector3[] triangleVerts = new btVector3[3];
			btVector3 aabbMin, aabbMax;
			btVector3 meshScaling; meshInterface.getScaling( out meshScaling );
