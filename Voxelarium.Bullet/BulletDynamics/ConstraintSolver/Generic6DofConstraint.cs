...
btGeneric6DofConstraint::btGeneric6DofConstraint(btRigidBody rbA, btRigidBody rbB, ref btTransform frameInA, ref btTransform frameInB, bool useLinearReferenceFrameA)
...
btGeneric6DofConstraint::btGeneric6DofConstraint(btRigidBody rbB, ref btTransform frameInB, bool useLinearReferenceFrameB)
...
double btGetMatrixElem(btMatrix3x3& mat, int index);
double btGetMatrixElem(btMatrix3x3& mat, int index)
{
	int i = index%3;
	int j = index/3;
...
bool	matrixToEulerXYZ(btMatrix3x3 mat,ref btVector3 xyz);
bool	matrixToEulerXYZ(btMatrix3x3& mat,ref btVector3 xyz)
{
	//	// rot =  cy*cz          -cy*sz           sy
...
int btRotationalLimitMotor::testLimitValue(double test_value)
{
...
double btRotationalLimitMotor::solveAngularLimits(
	...
	btRigidBody * body0, btRigidBody * body1 )
{
	...
	double	lo = (double)(-BT_LARGE_FLOAT);
	double	hi = (double)(BT_LARGE_FLOAT);
...
int btTranslationalLimitMotor::testLimitValue(int limitIndex, double test_value)
{
...
double btTranslationalLimitMotor::solveLinearAxis(
	double timeStep,
	double jacDiagABInv,
...
void btGeneric6DofConstraint::calculateTransforms(ref btTransform transA,ref btTransform transB)
{
...
void btGeneric6DofConstraint::buildJacobian()
{
	...
	if (m_useSolveConstraintObsolete)
	{
		...
		//  ref btVector3 pivotAInW = m_calculatedTransformA.getOrigin();
		//  ref btVector3 pivotBInW = m_calculatedTransformB.getOrigin();
		calcAnchorPos();
...
void btGeneric6DofConstraint::getInfo2NonVirtual (btConstraintInfo2* info, ref btTransform transA,ref btTransform transB,ref btVector3 linVelA,ref btVector3 linVelB,ref btVector3 angVelA,ref btVector3 angVelB)
{
...
int btGeneric6DofConstraint::setLinearLimits(btConstraintInfo2* info, int row, ref btTransform transA,ref btTransform transB,ref btVector3 linVelA,ref btVector3 linVelB,ref btVector3 angVelA,ref btVector3 angVelB)
{
//	int row = 0;
	//solve linear limits
...
int btGeneric6DofConstraint::setAngularLimits(btConstraintInfo2 *info, int row_offset, ref btTransform transA,ref btTransform transB,ref btVector3 linVelA,ref btVector3 linVelB,ref btVector3 angVelA,ref btVector3 angVelB)
{
...
void	btGeneric6DofConstraint::updateRHS(double	timeStep)
{
	(void)timeStep;
...
void btGeneric6DofConstraint::setFrames(ref btTransform frameA, ref btTransform frameB)
{
	m_frameInA = frameA;
	m_frameInB = frameB;
	buildJacobian();
...
btVector3 btGeneric6DofConstraint::getAxis(int axis_index)
{
	return m_calculatedAxis[axis_index];
}


double	btGeneric6DofConstraint::getRelativePivotPosition(int axisIndex)
{
	return m_calculatedLinearDiff[axisIndex];
}


double btGeneric6DofConstraint::getAngle(int axisIndex)
{
...
void btGeneric6DofConstraint::calcAnchorPos(void)
{
	...
	ref btVector3 pA = m_calculatedTransformA.getOrigin();
	ref btVector3 pB = m_calculatedTransformB.getOrigin();
	m_AnchorPos = pA * weight + pB * ((double)(1.0) - weight);
	return;
}
	...
	btConstraintInfo2 *info, int row, ref btVector3 ax1, int rotational,int rotAllowed)
{
    ...
    {   // if the joint is powered, or has joint limits, add in the extra row
        ...
        info.m_constraintError[srow] = (double)(0);
        if (powered)
        {
...
void btGeneric6DofConstraint::setParam(int num, double value, int axis)
{
	if((axis >= 0) && (axis < 3))
	{
		switch(num)
...
double btGeneric6DofConstraint::getParam(int num, int axis) string {
	double retVal = 0;
	if((axis >= 0) && (axis < 3))
	{
		switch(num)
...
void btGeneric6DofConstraint::setAxis(ref btVector3 axis1,ref btVector3 axis2)
{
