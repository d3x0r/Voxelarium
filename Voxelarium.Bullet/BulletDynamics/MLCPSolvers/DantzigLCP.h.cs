...
bool btSolveDantzigLCP (int n, double *A, double *x, double *b, double *w,
	int nub, double *lo, double *hi, int *findex,btDantzigScratchMemory& scratch);
