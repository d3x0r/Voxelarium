...
public:
	...
	btMultiBodyJointMotor(btMultiBody* body, int link, double desiredVelocity, double maxMotorImpulse);
    ...
    virtual void setVelocityTarget(double velTarget)
    {
