...
#if ! BT_MULTIBODY_DYNAMICS_WORLD_H
...
{
protected:
	List<btMultiBody*> m_multiBodies;
	List<btMultiBodyConstraint*> m_multiBodyConstraints;
	List<btMultiBodyConstraint*> m_sortedMultiBodyConstraints;
...
public:
	...
	virtual int		getNumMultibodies()
	{
		return m_multiBodies.Count;
	}
	...
	virtual int     getNumMultiBodyConstraints()
	{
        return m_multiBodyConstraints.Count;
	}
	...
	virtual void	integrateTransforms(double timeStep);
