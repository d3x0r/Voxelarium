...
#if ! BT_MULTIBODY_SOLVER_CONSTRAINT_H
...
ATTRIBUTE_ALIGNED16 (struct)	btMultiBodySolverConstraint
{
    ...
    double		m_lowerLimit;
	double		m_upperLimit;
	double		m_rhsPenetration;
    union
	{
		object		m_originalContactPoint;
...
typedef btList<btMultiBodySolverConstraint>	btMultiBodyConstraintArray;
